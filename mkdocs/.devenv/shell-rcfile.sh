...
source "/home/fr3d/musings/mkdocs/.devenv/shell-env.sh"
...
__devenv_reload_apply() {
    ...
    if [ -f "/tmp/devenv-reload-160768.sh" ]; then
        ...
        source "/tmp/devenv-reload-160768.sh"
        rm -f "/tmp/devenv-reload-160768.sh"
